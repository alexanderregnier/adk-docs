...
1. **`VertexAiSessionService`**
   ...
   - **Requires:**
     ...
     - If you do not have a Google Cloud project and you want to try the VertexAiSessionService for free, see how to [try Session and Memory for free.](https://google.github.io/adk-docs/sessions/express-mode/index.md)
