...
The [Firecrawl MCP Server](https://github.com/firecrawl/firecrawl-mcp-server) connects your ADK agent to the [Firecrawl](https://www.firecrawl.dev/) API, a service that can crawl any website and convert its content into clean, structured markdown. This allows your agent to ingest, search, and reason over web data from any URL, including all its subpages.
