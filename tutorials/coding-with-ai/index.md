...
The Agent Development Kit (ADK) documentation supports the [`/llms.txt`](https://llmstxt.org/) standard, providing a machine-readable index of the documentation optimized for Large Language Models (LLMs). This allows you to easily use the ADK documentation as context in your AI-powered development environment.
...
Refer to the [Antigravity MCP](https://antigravity.google/docs/mcp) documentation for more information on managing MCP servers.
